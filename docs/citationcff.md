...
|----------------------------|---------------------------------------|---------------------|
| citation - author - name | citation[i].result.author[i].name | authors / preferred-citation.authors |
| citation - author - family_name | citation[i].result.author[i].family_name | authors.family-names |
| citation - author - given_name | citation[i].result.author[i].given_name | authors.given-names |
| citation - author - url | citation[i].result.author[i].url | authors.orcid |
