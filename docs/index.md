...
- **Funding**: Funding information associated with the project, either as a structured grant or as links to crowdfunding platforms. Extracted from `codemeta.json` files and from the README (section headers and crowdfunding badges).
