...
WIDOCO has been tested on the following operating systems:
- Windows 10 and Windows 11
- Linux (Ubuntu 20.04, Debian 11)
- macOS 12 (Monterey) and later

WIDOCO can also be run using Docker (see Docker execution section above) or via a conda environment.
